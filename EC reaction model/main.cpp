...
void foo(double variable1, double variable2,double variable3) {
	...
	double K1 = dimKf*dElectrode*dElectrode / DA;
	...
	std::string ConcALocation = "concA =" + to_sci(concA) + "K1 = " + to_sci(K1) + "Sigma=" + to_sci(sigma) + "K0=" +to_sci(K0);
	std::string ConcBLocation = "concB =" + to_sci(concB) + "K1 = " + to_sci(K1) + "Sigma=" + to_sci(sigma) + "K0=" + to_sci(K0);
	std::string ConcYLocation = "concY =" + to_sci(concY) + "K1 = " + to_sci(K1) + "Sigma=" + to_sci(sigma) + "K0=" + to_sci(K0);
...
int main() {
	...
	double sigma[] = {scanRate,scanRate*1e-1,scanRate*1e-2,scanRate*1e-3,scanRate*1e1,scanRate*1e2};
