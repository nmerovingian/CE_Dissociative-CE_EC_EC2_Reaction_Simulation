...
public:
	...
	double** A = nullptr;
	double** J = nullptr;
	Coeff(double maxX, double K0_input, double Kf_input, double Kb_input, double deltaT, double alpha_input, double cAstar, double gamma, double dB_input, double dY_input);
    ~Coeff();
    ...
    void update(double* x, double Theta, double deltaX,double concA, double concB, double concC);
